...
class GeslachtTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'Model.Custom.NovumBrp.Stam.Map.GeslachtTableMap';
     ...
     */
    const OM_CLASS = '\\Model\\Custom\\NovumBrp\\Stam\\Geslacht';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'Model.Custom.NovumBrp.Stam.Geslacht';
    ...
    public function initialize()
    {
        ...
        $this->setClassName('\\Model\\Custom\\NovumBrp\\Stam\\Geslacht');
    ...
    {
        $this->addRelation('Persoon', '\\Model\\Custom\\NovumBrp\\Persoonsgegevens\\Persoon', RelationMap::ONE_TO_MANY, array (
  0 =>
  array (
    0 => ':geslacht_id',
    1 => ':id',
     ...
     */
     public static function doDelete($values, ConnectionInterface $con = null)
     {
        ...
        if ($values instanceof Criteria) {
            // rename for clarity
            $criteria = $values;
        } elseif ($values instanceof \Model\Custom\NovumBrp\Stam\Geslacht) { // it's a model object

...
class LandTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'Model.Custom.NovumBrp.Stam.Map.LandTableMap';
     ...
     */
    const OM_CLASS = '\\Model\\Custom\\NovumBrp\\Stam\\Land';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'Model.Custom.NovumBrp.Stam.Land';
    ...
    public function initialize()
    {
        ...
        $this->setClassName('\\Model\\Custom\\NovumBrp\\Stam\\Land');
     ...
     */
     public static function doDelete($values, ConnectionInterface $con = null)
     {
        ...
        if ($values instanceof Criteria) {
            // rename for clarity
            $criteria = $values;
        } elseif ($values instanceof \Model\Custom\NovumBrp\Stam\Land) { // it's a model object

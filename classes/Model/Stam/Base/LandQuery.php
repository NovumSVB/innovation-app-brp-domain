...
abstract class LandQuery extends ModelCriteria
{
    ...
    /**
     * Initializes internal state of \Model\Custom\NovumBrp\Stam\Base\LandQuery object.
     *
     * @param     string $dbName The database name
     * @param     string $modelName The phpName of a model, e.g. 'Book'
     * @param     string $modelAlias The alias for the model in this query, e.g. 'b'
     */
    public function __construct($dbName = 'hurah', $modelName = '\\Model\\Custom\\NovumBrp\\Stam\\Land', $modelAlias = null)
    {

...
class Persoon_relatieTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'Model.Custom.NovumBrp.Persoonsgegevens.Map.Persoon_relatieTableMap';
     ...
     */
    const OM_CLASS = '\\Model\\Custom\\NovumBrp\\Persoonsgegevens\\Persoon_relatie';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'Model.Custom.NovumBrp.Persoonsgegevens.Persoon_relatie';
    ...
    public function initialize()
    {
        ...
        $this->setClassName('\\Model\\Custom\\NovumBrp\\Persoonsgegevens\\Persoon_relatie');
     ...
     */
     public static function doDelete($values, ConnectionInterface $con = null)
     {
        ...
        if ($values instanceof Criteria) {
            // rename for clarity
            $criteria = $values;
        } elseif ($values instanceof \Model\Custom\NovumBrp\Persoonsgegevens\Persoon_relatie) { // it's a model object

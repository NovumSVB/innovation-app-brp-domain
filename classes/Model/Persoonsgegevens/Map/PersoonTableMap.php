...
class PersoonTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'Model.Custom.NovumBrp.Persoonsgegevens.Map.PersoonTableMap';
     ...
     */
    const OM_CLASS = '\\Model\\Custom\\NovumBrp\\Persoonsgegevens\\Persoon';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'Model.Custom.NovumBrp.Persoonsgegevens.Persoon';
    ...
    public function initialize()
    {
        ...
        $this->setClassName('\\Model\\Custom\\NovumBrp\\Persoonsgegevens\\Persoon');
    ...
    {
        $this->addRelation('Land', '\\Model\\Custom\\NovumBrp\\Stam\\Land', RelationMap::MANY_TO_ONE, array (
  0 =>
  array (
    0 => ':geboorte_land_id',
    1 => ':id',
  ...
  array (
    ...
    1 => ':id',
        ...
        $this->addRelation('FkVader', '\\Model\\Custom\\NovumBrp\\Persoonsgegevens\\Persoon', RelationMap::MANY_TO_ONE, array (
  0 =>
  array (
    0 => ':vader_id',
    1 => ':id',
        ...
        $this->addRelation('FkMoeder', '\\Model\\Custom\\NovumBrp\\Persoonsgegevens\\Persoon', RelationMap::MANY_TO_ONE, array (
  0 =>
  array (
    0 => ':moeder_id',
    1 => ':id',
        ...
        $this->addRelation('PersoonRelatedById0', '\\Model\\Custom\\NovumBrp\\Persoonsgegevens\\Persoon', RelationMap::ONE_TO_MANY, array (
  0 =>
  array (
    0 => ':vader_id',
    1 => ':id',
        ...
        $this->addRelation('PersoonRelatedById1', '\\Model\\Custom\\NovumBrp\\Persoonsgegevens\\Persoon', RelationMap::ONE_TO_MANY, array (
  0 =>
  array (
    0 => ':moeder_id',
    1 => ':id',
     ...
     */
     public static function doDelete($values, ConnectionInterface $con = null)
     {
        ...
        if ($values instanceof Criteria) {
            // rename for clarity
            $criteria = $values;
        } elseif ($values instanceof \Model\Custom\NovumBrp\Persoonsgegevens\Persoon) { // it's a model object

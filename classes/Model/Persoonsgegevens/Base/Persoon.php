...
abstract class Persoon implements ActiveRecordInterface
{
     ...
     * TableMap class name
     */
    const TABLE_MAP = '\\Model\\Custom\\NovumBrp\\Persoonsgegevens\\Map\\PersoonTableMap';
    ...
    /**
     * Initializes internal state of Model\Custom\NovumBrp\Persoonsgegevens\Base\Persoon object.
     */
     ...
     * @return $this|\Model\Custom\NovumBrp\Persoonsgegevens\Persoon The current object (for fluent API support)
     */
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            throw new PropelException(sprintf('Error populating %s object', '\\Model\\Custom\\NovumBrp\\Persoonsgegevens\\Persoon'), 0, $e);
        }
    }
     ...
     *                TableMap::TYPE_COLNAME, TableMap::TYPE_FIELDNAME, TableMap::TYPE_NUM.
     *                Defaults to TableMap::TYPE_PHPNAME.
     * @return $this|\Model\Custom\NovumBrp\Persoonsgegevens\Persoon
     */
     ...
     * @param string $keyType The type of keys the array uses.
     *
     * @return $this|\Model\Custom\NovumBrp\Persoonsgegevens\Persoon The current object, for fluid interface
     */
     ...
     * objects.
     *
     * @param      object $copyObj An object of \Model\Custom\NovumBrp\Persoonsgegevens\Persoon (or compatible) type.
     ...
     *
     * @param  boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \Model\Custom\NovumBrp\Persoonsgegevens\Persoon Clone of current object.
     * @throws PropelException
     */
    ...
    public function initPersoonsRelatedById0($overrideExisting = true)
    {
        ...
        $this->collPersoonsRelatedById0->setModel('\Model\Custom\NovumBrp\Persoonsgegevens\Persoon');
    }
    ...
    public function initPersoonsRelatedById1($overrideExisting = true)
    {
        ...
        $this->collPersoonsRelatedById1->setModel('\Model\Custom\NovumBrp\Persoonsgegevens\Persoon');
    }

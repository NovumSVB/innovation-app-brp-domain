 ...
 *
 * @method     \Model\Custom\NovumBrp\Stam\Relatie_typeQuery|\Model\Custom\NovumBrp\Persoonsgegevens\Persoon_relatieQuery endUse() Finalizes a secondary criteria and merges it with its primary Criteria
 *
...
abstract class RelatieQuery extends ModelCriteria
{
    ...
    /**
     * Initializes internal state of \Model\Custom\NovumBrp\Persoonsgegevens\Base\RelatieQuery object.
     *
     * @param     string $dbName The database name
     * @param     string $modelName The phpName of a model, e.g. 'Book'
     * @param     string $modelAlias The alias for the model in this query, e.g. 'b'
     */
    public function __construct($dbName = 'hurah', $modelName = '\\Model\\Custom\\NovumBrp\\Persoonsgegevens\\Relatie', $modelAlias = null)
    {
    ...
    /**
     * Filter the query by a related \Model\Custom\NovumBrp\Stam\Relatie_type object
     *
     * @param \Model\Custom\NovumBrp\Stam\Relatie_type|ObjectCollection $relatie_type The related object(s) to use as filter
     * @param string $comparison Operator to use for the column comparison, defaults to Criteria::EQUAL
     *
     * @throws \Propel\Runtime\Exception\PropelException
     *
    ...
    {
        if ($relatie_type instanceof \Model\Custom\NovumBrp\Stam\Relatie_type) {
            return $this
            ...
            throw new PropelException('filterByRelatieType() only accepts arguments of type \Model\Custom\NovumBrp\Stam\Relatie_type or Collection');
        }
    }
     ...
     * @param     string $joinType Accepted values are null, 'left join', 'right join', 'inner join'
     *
     * @return \Model\Custom\NovumBrp\Stam\Relatie_typeQuery A secondary query class using the current class as primary query
     */
    public function useRelatieTypeQuery($relationAlias = null, $joinType = Criteria::INNER_JOIN)
    {
        return $this
            ...
            ->useQuery($relationAlias ? $relationAlias : 'RelatieType', '\Model\Custom\NovumBrp\Stam\Relatie_typeQuery');
    }

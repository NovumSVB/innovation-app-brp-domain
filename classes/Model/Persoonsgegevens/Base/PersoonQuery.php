 ...
 *
 * @method     \Model\Custom\NovumBrp\Stam\LandQuery|\Model\Custom\NovumBrp\Stam\GeslachtQuery|\Model\Custom\NovumBrp\Persoonsgegevens\PersoonQuery|\Model\Custom\NovumBrp\Persoonsgegevens\Persoon_relatieQuery endUse() Finalizes a secondary criteria and merges it with its primary Criteria
 *
...
abstract class PersoonQuery extends ModelCriteria
{
    ...
    /**
     * Initializes internal state of \Model\Custom\NovumBrp\Persoonsgegevens\Base\PersoonQuery object.
     *
     * @param     string $dbName The database name
     * @param     string $modelName The phpName of a model, e.g. 'Book'
     * @param     string $modelAlias The alias for the model in this query, e.g. 'b'
     */
    public function __construct($dbName = 'hurah', $modelName = '\\Model\\Custom\\NovumBrp\\Persoonsgegevens\\Persoon', $modelAlias = null)
    {
    ...
    /**
     * Filter the query by a related \Model\Custom\NovumBrp\Stam\Land object
     *
     * @param \Model\Custom\NovumBrp\Stam\Land|ObjectCollection $land The related object(s) to use as filter
     * @param string $comparison Operator to use for the column comparison, defaults to Criteria::EQUAL
     *
     * @throws \Propel\Runtime\Exception\PropelException
     *
    ...
    {
        if ($land instanceof \Model\Custom\NovumBrp\Stam\Land) {
            return $this
            ...
            throw new PropelException('filterByLand() only accepts arguments of type \Model\Custom\NovumBrp\Stam\Land or Collection');
        }
    }
     ...
     * @param     string $joinType Accepted values are null, 'left join', 'right join', 'inner join'
     *
     * @return \Model\Custom\NovumBrp\Stam\LandQuery A secondary query class using the current class as primary query
     */
    public function useLandQuery($relationAlias = null, $joinType = Criteria::LEFT_JOIN)
    {
        return $this
            ->joinLand($relationAlias, $joinType)
            ->useQuery($relationAlias ? $relationAlias : 'Land', '\Model\Custom\NovumBrp\Stam\LandQuery');
    }
    ...
    public function filterByFkVader($persoon, $comparison = null)
    {
        if ($persoon instanceof \Model\Custom\NovumBrp\Persoonsgegevens\Persoon) {
            ...
            throw new PropelException('filterByFkVader() only accepts arguments of type \Model\Custom\NovumBrp\Persoonsgegevens\Persoon or Collection');
        }
    }
    ...
    public function useFkVaderQuery($relationAlias = null, $joinType = Criteria::LEFT_JOIN)
    {
        return $this
            ...
            ->useQuery($relationAlias ? $relationAlias : 'FkVader', '\Model\Custom\NovumBrp\Persoonsgegevens\PersoonQuery');
    }
    ...
    public function filterByFkMoeder($persoon, $comparison = null)
    {
        if ($persoon instanceof \Model\Custom\NovumBrp\Persoonsgegevens\Persoon) {
            ...
            throw new PropelException('filterByFkMoeder() only accepts arguments of type \Model\Custom\NovumBrp\Persoonsgegevens\Persoon or Collection');
        }
    }
    ...
    public function useFkMoederQuery($relationAlias = null, $joinType = Criteria::LEFT_JOIN)
    {
        return $this
            ...
            ->useQuery($relationAlias ? $relationAlias : 'FkMoeder', '\Model\Custom\NovumBrp\Persoonsgegevens\PersoonQuery');
    }

    /**
     * Filter the query by a related \Model\Custom\NovumBrp\Persoonsgegevens\Persoon object
     *
     * @param \Model\Custom\NovumBrp\Persoonsgegevens\Persoon|ObjectCollection $persoon the related object to use as filter
     * @param string $comparison Operator to use for the column comparison, defaults to Criteria::EQUAL
     *
     * @return ChildPersoonQuery The current query, for fluid interface
     */
    public function filterByPersoonRelatedById0($persoon, $comparison = null)
    {
        if ($persoon instanceof \Model\Custom\NovumBrp\Persoonsgegevens\Persoon) {
            ...
            throw new PropelException('filterByPersoonRelatedById0() only accepts arguments of type \Model\Custom\NovumBrp\Persoonsgegevens\Persoon or Collection');
        }
    }
    ...
    public function usePersoonRelatedById0Query($relationAlias = null, $joinType = Criteria::LEFT_JOIN)
    {
        return $this
            ...
            ->useQuery($relationAlias ? $relationAlias : 'PersoonRelatedById0', '\Model\Custom\NovumBrp\Persoonsgegevens\PersoonQuery');
    }
    ...
    public function filterByPersoonRelatedById1($persoon, $comparison = null)
    {
        if ($persoon instanceof \Model\Custom\NovumBrp\Persoonsgegevens\Persoon) {
            ...
            throw new PropelException('filterByPersoonRelatedById1() only accepts arguments of type \Model\Custom\NovumBrp\Persoonsgegevens\Persoon or Collection');
        }
    }
    ...
    public function usePersoonRelatedById1Query($relationAlias = null, $joinType = Criteria::LEFT_JOIN)
    {
        return $this
            ...
            ->useQuery($relationAlias ? $relationAlias : 'PersoonRelatedById1', '\Model\Custom\NovumBrp\Persoonsgegevens\PersoonQuery');
    }

    /**
     * Filter the query by a related \Model\Custom\NovumBrp\Persoonsgegevens\Persoon_relatie object
     *
     * @param \Model\Custom\NovumBrp\Persoonsgegevens\Persoon_relatie|ObjectCollection $persoon_relatie the related object to use as filter
     * @param string $comparison Operator to use for the column comparison, defaults to Criteria::EQUAL
     *
     * @return ChildPersoonQuery The current query, for fluid interface
     */
    ...
    {
        if ($persoon_relatie instanceof \Model\Custom\NovumBrp\Persoonsgegevens\Persoon_relatie) {
            return $this
            ...
            throw new PropelException('filterByPersoon_relatie() only accepts arguments of type \Model\Custom\NovumBrp\Persoonsgegevens\Persoon_relatie or Collection');
        }
    }
     ...
     * @param     string $joinType Accepted values are null, 'left join', 'right join', 'inner join'
     *
     * @return \Model\Custom\NovumBrp\Persoonsgegevens\Persoon_relatieQuery A secondary query class using the current class as primary query
     */
    public function usePersoon_relatieQuery($relationAlias = null, $joinType = Criteria::INNER_JOIN)
    {
        return $this
            ...
            ->useQuery($relationAlias ? $relationAlias : 'Persoon_relatie', '\Model\Custom\NovumBrp\Persoonsgegevens\Persoon_relatieQuery');
    }

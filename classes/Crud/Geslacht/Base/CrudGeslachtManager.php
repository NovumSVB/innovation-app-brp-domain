<?php
namespace Crud\Custom\NovumBrp\Geslacht\Base;
...
abstract class CrudGeslachtManager extends FormManager implements IConfigurableCrud, IApiExposable
{
	...
	{
		return new \Model\Custom\NovumBrp\Stam\Map\GeslachtTableMap();
	}
	...
	{
		return "/custom/novumbrp/stamtabellen/geslacht/overview";
	}


	public function getEditUrl(): string
	{
		return "/custom/novumbrp/stamtabellen/geslacht/edit";
	}

<?php
namespace Crud\Custom\NovumBrp\Persoon\Base;
...
abstract class CrudPersoonManager extends FormManager implements IConfigurableCrud, IApiExposable
{
	...
	{
		return new \Model\Custom\NovumBrp\Persoonsgegevens\Map\PersoonTableMap();
	}
	...
	{
		return "/custom/novumbrp/basisregistratie/persoon/overview";
	}


	public function getEditUrl(): string
	{
		return "/custom/novumbrp/basisregistratie/persoon/edit";
	}
	...
	{
		return ['Bsn', 'Infix', 'Voornaam', 'Achternaam', 'Vader', 'Moeder', 'GeslachtId', 'GeboorteDatum', 'GeboortePlaats', 'GeboorteLand', 'Immigratiedatum', 'HeeftNederlandsPaspoort', 'SterfDatum', 'SterfPlaats', 'Delete', 'Edit'];
	}

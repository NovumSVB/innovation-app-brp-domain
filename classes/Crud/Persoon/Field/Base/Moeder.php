...
abstract class Moeder extends GenericLookup implements IFilterableField, IEditableField, IFilterableLookupField
{
	...
	{
		$aAllRows = \Model\Custom\NovumBrp\Persoonsgegevens\PersoonQuery::create()->orderByBsn()->find();
	...
	{
		if($iItemId){
		    return \Model\Custom\NovumBrp\Persoonsgegevens\PersoonQuery::create()->findOneById($iItemId)->getBsn();
		}
		return null;
	}

...
abstract class GeslachtId extends GenericLookup implements IFilterableField, IEditableField, IFilterableLookupField, IRequiredField
{
	...
	{
		$aAllRows = \Model\Custom\NovumBrp\Stam\GeslachtQuery::create()->orderByNaam()->find();
	...
	{
		if($iItemId){
		    return \Model\Custom\NovumBrp\Stam\GeslachtQuery::create()->findOneById($iItemId)->getNaam();
		}
		return null;
	}

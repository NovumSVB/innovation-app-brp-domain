<?php
namespace Crud\Custom\NovumBrp\Land\Base;
...
abstract class CrudLandManager extends FormManager implements IConfigurableCrud, IApiExposable
{
	...
	{
		return new \Model\Custom\NovumBrp\Stam\Map\LandTableMap();
	}
	...
	{
		return "/custom/novumbrp/stamtabellen/land/overview";
	}


	public function getEditUrl(): string
	{
		return "/custom/novumbrp/stamtabellen/land/edit";
	}

...
abstract class ProvincieId extends GenericLookup implements IFilterableField, IEditableField, IFilterableLookupField, IRequiredField
{
	...
	{
		$aAllRows = \Model\Custom\NovumBrp\Stam\ProvincieQuery::create()->orderByNaam()->find();
	...
	{
		if($iItemId){
		    return \Model\Custom\NovumBrp\Stam\ProvincieQuery::create()->findOneById($iItemId)->getNaam();
		}
		return null;
	}

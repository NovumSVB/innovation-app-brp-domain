...
abstract class GemeenteId extends GenericLookup implements IFilterableField, IEditableField, IFilterableLookupField, IRequiredField
{
	...
	{
		$aAllRows = \Model\Custom\NovumBrp\Stam\GemeenteQuery::create()->orderByNaam()->find();
	...
	{
		if($iItemId){
		    return \Model\Custom\NovumBrp\Stam\GemeenteQuery::create()->findOneById($iItemId)->getNaam();
		}
		return null;
	}

<?php
namespace Crud\Custom\NovumBrp\Adres\Base;
...
abstract class CrudAdresManager extends FormManager implements IConfigurableCrud, IApiExposable
{
	...
	{
		return new \Model\Custom\NovumBrp\Persoonsgegevens\Map\AdresTableMap();
	}
	...
	{
		return "/custom/novumbrp/basisregistratie/adres/overview";
	}


	public function getEditUrl(): string
	{
		return "/custom/novumbrp/basisregistratie/adres/edit";
	}
	...
	{
		return ['PersoonId', 'ProvincieId', 'GemeenteId', 'Straat', 'Huisnummer', 'Postcode', 'Delete', 'Edit'];
	}

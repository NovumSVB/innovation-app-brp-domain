<?php
namespace Crud\Custom\NovumBrp\Relatie\Base;
...
abstract class CrudRelatieManager extends FormManager implements IConfigurableCrud, IApiExposable
{
	...
	{
		return new \Model\Custom\NovumBrp\Persoonsgegevens\Map\RelatieTableMap();
	}
	...
	{
		return "/custom/novumbrp/basisregistratie/relatie/overview";
	}


	public function getEditUrl(): string
	{
		return "/custom/novumbrp/basisregistratie/relatie/edit";
	}
	...
	{
		return ['Relatie_type', 'RelatieStart', 'RelatieEinde', 'Delete', 'Edit'];
	}

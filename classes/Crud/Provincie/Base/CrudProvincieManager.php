<?php
namespace Crud\Custom\NovumBrp\Provincie\Base;
...
abstract class CrudProvincieManager extends FormManager implements IConfigurableCrud, IApiExposable
{
	...
	{
		return new \Model\Custom\NovumBrp\Stam\Map\ProvincieTableMap();
	}
	...
	{
		return "/custom/novumbrp/stamtabellen/provincie/overview";
	}


	public function getEditUrl(): string
	{
		return "/custom/novumbrp/stamtabellen/provincie/edit";
	}

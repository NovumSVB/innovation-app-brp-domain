<?php
namespace Crud\Custom\NovumBrp\Relatie_type\Base;
...
abstract class CrudRelatie_typeManager extends FormManager implements IConfigurableCrud, IApiExposable
{
	...
	{
		return new \Model\Custom\NovumBrp\Stam\Map\Relatie_typeTableMap();
	}
	...
	{
		return "/custom/novumbrp/stamtabellen/relatie_type/overview";
	}


	public function getEditUrl(): string
	{
		return "/custom/novumbrp/stamtabellen/relatie_type/edit";
	}

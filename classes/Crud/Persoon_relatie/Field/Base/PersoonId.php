...
use Model\Custom\NovumBrp\PersoonQuery;

/**
 * Base class that represents the 'persoon_id' crud field from the 'persoon_relatie' table.
...
abstract class PersoonId extends GenericLookup implements IFilterableField, IEditableField, IFilterableLookupField, IRequiredField
{
	...
	protected $sFqModelClassname = '\Model\Custom\NovumBrp\Persoonsgegevens\Persoon_relatie';
	...
	{
		$aAllRows = \Model\Custom\NovumBrp\PersoonQuery::create()->orderByBsn()->find();
	...
	{
		if($iItemId){
		    return \Model\Custom\NovumBrp\PersoonQuery::create()->findOneById($iItemId)->getBsn();
		}
		return null;
	}

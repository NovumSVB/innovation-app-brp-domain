<?php
namespace Crud\Custom\NovumBrp\Persoon_relatie\Base;
...
abstract class CrudPersoon_relatieManager extends FormManager implements IConfigurableCrud, IApiExposable
{
	...
	{
		return new \Model\Custom\NovumBrp\Persoonsgegevens\Map\Persoon_relatieTableMap();
	}
	...
	{
		return "/custom/novumbrp/basisregistratie/persoon_relatie/overview";
	}


	public function getEditUrl(): string
	{
		return "/custom/novumbrp/basisregistratie/persoon_relatie/edit";
	}
	...
	{
		return ['RelatieId', 'PersoonId', 'Delete', 'Edit'];
	}

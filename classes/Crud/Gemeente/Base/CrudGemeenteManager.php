<?php
namespace Crud\Custom\NovumBrp\Gemeente\Base;
...
abstract class CrudGemeenteManager extends FormManager implements IConfigurableCrud, IApiExposable
{
	...
	{
		return new \Model\Custom\NovumBrp\Stam\Map\GemeenteTableMap();
	}
	...
	{
		return "/custom/novumbrp/stamtabellen/gemeente/overview";
	}


	public function getEditUrl(): string
	{
		return "/custom/novumbrp/stamtabellen/gemeente/edit";
	}
